...
from app.technical_audit_api import router as technical_audit_router
...
from app.growth_agent.router import router as growth_agent_router
...
app.include_router(growth_agent_router)
BRANDED_TERMS = {
    "nolix": [
        "nolix",
        "nolix ai",
